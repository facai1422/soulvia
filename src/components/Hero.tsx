        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                className="btn-primary text-lg px-8 py-4 rounded-xl font-semibold shadow-2xl shadow-primary-500/25 hover:shadow-primary-500/40 inline-block text-center"
              >
                Download Soulvia App
              </a>
              <a 
                href="/3d-experience" 
                className="flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl backdrop-blur-sm border border-white/20 transition-all duration-300"
              >
          ...
          <div className={`relative ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
            <div className="relative">
              {/* Main device mockup */}
              <div className="relative z-10 bg-gradient-to-br from-dark-700 to-dark-800 rounded-3xl p-6 shadow-2xl border border-gray-700/50">
                <div className="bg-dark-900 rounded-2xl p-4 h-96">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-white font-medium">Anonymous Room</div>
                          <div className="text-gray-400 text-sm">24 members online</div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-primary-500/20 rounded-xl p-3 max-w-xs">
                        <div className="text-gray-300 text-sm">Finally a place where I can share my real thoughts...</div>
                        <div className="text-gray-500 text-xs mt-1">Anonymous • 2m ago</div>
                      </div>
                      <div className="bg-gray-700/30 rounded-xl p-3 max-w-xs ml-auto">
                        <div className="text-gray-300 text-sm">This feels so liberating! 🎭</div>
              ...
              <div className="absolute -top-4 -right-4 bg-green-500 text-white p-3 rounded-xl shadow-lg animate-float">
                <Lock className="w-6 h-6" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-primary-500 text-white p-3 rounded-xl shadow-lg animate-float" style={{animationDelay: '1s'}}>
